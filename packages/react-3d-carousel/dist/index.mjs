...
function GalleryCarousel({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    showNavigation && showArrows && models.length > 1 && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "fixed left-8 top-1/2 -translate-y-1/2 z-30", children: /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed right-8 top-1/2 -translate-y-1/2 z-30", children: /* @__PURE__ */ jsx(
        "button",
        {
          onClick: goToNext,
          className: "bg-white/20 hover:bg-white/30 backdrop-blur-md text-white p-4 rounded-full transition-all duration-300 shadow-lg border border-white/30",
    ...
    showNavigation && showDots && models.length > 1 && /* @__PURE__ */ jsx("div", { className: "fixed bottom-8 left-0 right-0 z-30 flex justify-center gap-2", children: models.map((_, index) => /* @__PURE__ */ jsx(
      "button",
      {
