...
function UniversalModel({ modelUrl, rotation, position = [0, -0.8, 0], scale = 1.5 }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("group", { rotation: [0, rotation, 0], children: /* @__PURE__ */ jsxRuntime.jsx(
    "primitive",
    {
      ref: meshRef,
      object: model,
...
function ProductViewer({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative", style: { height: `${scrollMultiplier * 100}vh` }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sticky top-0 w-full bg-linear-to-b from-slate-900 to-slate-700", style: { height }, children: [
    overlay && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute bottom-12 left-0 right-0 z-10 px-8 pb-8 pointer-events-none flex justify-center", children: overlay }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      fiber.Canvas,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("ambientLight", { intensity: 0.5 }),
          /* @__PURE__ */ jsxRuntime.jsx("directionalLight", { position: [10, 10, 5], intensity: 1 }),
          /* @__PURE__ */ jsxRuntime.jsx("directionalLight", { position: [-10, -10, -5], intensity: 0.5 }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(drei.OrbitControls, { enableZoom: false, enablePan: false, enabled: false })
        ]
      }
    )
  ] }) });
...
function GalleryCarousel({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-screen w-full flex items-center justify-center bg-slate-900", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "inline-block animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-blue-500 mb-4" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-white/70", children: "Loading Gallery..." })
    ] }) });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-screen w-full flex flex-col items-center justify-center bg-linear-to-b from-slate-900 to-slate-700", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center px-8", children: [
      /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white drop-shadow-lg mb-2", children: "3D Gallery" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-base md:text-lg text-white/60 drop-shadow-md mb-4", children: error }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-white/40", children: "Please check back later" })
    ] }) });
  }
  if (!models || models.length === 0) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-screen w-full flex items-center justify-center bg-slate-900", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-white text-2xl font-bold mb-2", children: "No Models Available" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-slate-400", children: "Please check back later" })
    ] }) });
  }
  const goToNext = () => {
  ...
  const overlay = /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white drop-shadow-lg mb-2", children: currentModel.name }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-base md:text-lg text-white/80 drop-shadow-md mb-4", children: currentModel.description }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center justify-center gap-2 text-sm text-white/60", children: /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
      currentIndex + 1,
      " / ",
      models.length
    ] }) })
